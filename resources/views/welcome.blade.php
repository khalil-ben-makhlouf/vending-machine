        ...
        <div class="items-center flex flex-wrap">
          <div class="w-full lg:w-6/12 px-4 ml-auto mr-auto text-center">
            <div class="pr-12">
              ...
              <p class="mt-4 text-lg text-gray-300">From the very beginning of Vendomat's operation, our team has been dedicated to providing high-quality services. </p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="lg:pt-12 pt-6 w-full md:w-4/12 px-4 text-center">
        <div class="relative flex flex-col min-w-0 break-words bg-white w-full mb-8 shadow-lg rounded-lg">
          <div class="px-4 py-5 flex-auto">
            ...
            <p class="mt-2 mb-4 text-gray-600">Effortlessly manage your vending machine products with our intuitive CRUD (Create, Read, Update, Delete) interface. Add, update, or remove products to optimize your offerings and maximize sales.</p>
          </div>
        </div>
      </div>
      ...
      <div class="flex flex-wrap items-center md:justify-between justify-center">
        <div class="w-full md:w-4/12 px-4 mx-auto text-center">
          <div class="text-sm text-gray-600 font-semibold py-1">
            © 2023 KSI VENDING MACHINE <a href="#" class="text-gray-600 hover:text-gray-900">. All Rights Reserved.</a>.
          </div>
        </div>
      </div>
    </div>
